...
public class CoffeeController {
    ...
    public void initialize() {
        coffeeGridPane.setAlignment(Pos.CENTER);
        loadCoffeeMenu();
    }
    ...
    private void loadCoffeeMenu() {
        ...
        try {
            ...
            for (QueryDocumentSnapshot document : querySnapshot.getDocuments()) {
                ...
                GridPane.setMargin(menuButton, new Insets(10, 5, 5, 5));
                coffeeGridPane.add(menuButton, col, row);
                col++;
                if (col == 3) {
                    col = 0;
                    row++;
    ...
    private void handleMenuSelection(ActionEvent event) {
        ...
        try {
            ...
            stage = (Stage) coffeeGridPane.getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        } catch (IOException e) {
