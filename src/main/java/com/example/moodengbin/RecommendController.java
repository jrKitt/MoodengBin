...
public class RecommendController {
    ...
    @FXML
    private GridPane RecommendedGridPane;
    ...
    public void initialize() {
        RecommendedGridPane.setAlignment(Pos.CENTER);
        loadRecommendedMenu();
    }

    private void loadRecommendedMenu() {
        ...
        try {
            ...
            for (QueryDocumentSnapshot document : querySnapshot.getDocuments()) {
                ...
                RecommendedGridPane.add(menuButton, col, row);
                col++;
                if (col == 3) {
                    col = 0;
                    row++;
    ...
    private void handleMenuSelection(ActionEvent event) {
        ...
        try {
            ...
            stage = (Stage) RecommendedGridPane.getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        } catch (IOException e) {
