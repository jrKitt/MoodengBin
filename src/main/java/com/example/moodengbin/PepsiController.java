...
public class PepsiController {
    ...
    @FXML
    private GridPane pepsiGridPane;
    ...
    private void loadPepsiMenu() {
        ...
        try {
            ...
            for (QueryDocumentSnapshot document : querySnapshot.getDocuments()) {
                ...
                pepsiGridPane.add(menuButton, col, row);
                col++;
                if (col == 3) {
                    col = 0;
                    row++;
    ...
    private void handleMenuSelection(ActionEvent event) {
        ...
        try {
            ...
            stage = (Stage) pepsiGridPane.getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        } catch (IOException e) {
